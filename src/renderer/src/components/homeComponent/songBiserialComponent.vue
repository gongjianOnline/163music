          ...
          <div class="pageContainer" >
            <div class="pageContainerItem" 
              ...
              <div class="PCIInfoContainer">
                ...
                <div>
                  <span class="PCITag" v-show="item.reason">{{item.reason}}</span>
                  <span class="PCIAuthor" v-show="item.name">{{ item.al.name}}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="pageContainer" >
            <div class="pageContainerItem" 
              ...
              <div class="PCIInfoContainer">
                ...
                <div>
                  <span class="PCITag" v-show="item.reason">{{item.reason}}</span>
                  <span class="PCIAuthor" v-show="!item.alia[0]">{{item.alia[0]}}</span>
                </div>
              </div>
            </div>
          </div>
